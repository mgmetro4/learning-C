...
struct	pentry	{
	...
	int counter;		/* time quantum counter for Linux Scheduler	*/
	int	goodness;		/* dynamic priority level for Linux Scheduler */
	int new_pprio;		/* pprio that will update only when a new epoch is started for Linux Scheduler */
};
